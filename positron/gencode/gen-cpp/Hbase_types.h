...
typedef struct _TScan__isset {
  _TScan__isset() : startRow(false), stopRow(false), timestamp(false), columns(false), caching(false), filterString(false), batchSize(false) {}
  bool startRow;
  bool stopRow;
  bool timestamp;
  bool columns;
...
class TScan {
 public:
  ...
  static const char* ascii_fingerprint; // = "8011BE09E54D375123BFE94E02753829";
  static const uint8_t binary_fingerprint[16]; // = {0x80,0x11,0xBE,0x09,0xE5,0x4D,0x37,0x51,0x23,0xBF,0xE9,0x4E,0x02,0x75,0x38,0x29};

  TScan() : startRow(), stopRow(), timestamp(0), caching(0), filterString(), batchSize(0) {
  }
