...
class ChildServiceCobClIfT : virtual public ParentServiceCobClIfT<Protocol_> {
 public:
  ...
  virtual void setValue(std::tr1::function<void(ChildServiceCobClientT<Protocol_>* client)> cob, const int32_t value) = 0;
  virtual void getValue(std::tr1::function<void(ChildServiceCobClientT<Protocol_>* client)> cob) = 0;
};
...
class ChildServiceCobSvIf : virtual public ParentServiceCobSvIf {
 public:
  ...
  virtual void setValue(std::tr1::function<void(int32_t const& _return)> cob, const int32_t value) = 0;
  virtual void getValue(std::tr1::function<void(int32_t const& _return)> cob) = 0;
};
...
class ChildServiceCobSvNull : virtual public ChildServiceCobSvIf , virtual public ParentServiceCobSvNull {
 public:
  ...
  void setValue(std::tr1::function<void(int32_t const& _return)> cob, const int32_t /* value */) {
    int32_t _return = 0;
    return cob(_return);
  }
  void getValue(std::tr1::function<void(int32_t const& _return)> cob) {
    int32_t _return = 0;
    return cob(_return);
  }
};
...
class ChildServiceCobClientT : virtual public ChildServiceCobClIfT<Protocol_>, public ParentServiceCobClientT<Protocol_> {
 public:
  ...
  void setValue(std::tr1::function<void(ChildServiceCobClientT<Protocol_>* client)> cob, const int32_t value);
  void send_setValue(const int32_t value);
  int32_t recv_setValue();
  void getValue(std::tr1::function<void(ChildServiceCobClientT<Protocol_>* client)> cob);
  void send_getValue();
  int32_t recv_getValue();
};
...
class ChildServiceAsyncProcessorT : public ParentServiceAsyncProcessorT<Protocol_> {
 ...
 private:
  typedef  void (ChildServiceAsyncProcessorT::*ProcessFunction)(std::tr1::function<void(bool ok)>, int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*);
  typedef void (ChildServiceAsyncProcessorT::*SpecializedProcessFunction)(std::tr1::function<void(bool ok)>, int32_t, Protocol_*, Protocol_*);
  struct ProcessFunctions {
    ProcessFunction generic;
    SpecializedProcessFunction specialized;
    ProcessFunctions(ProcessFunction g, SpecializedProcessFunction s) :
  ...
  typedef std::map<std::string, ProcessFunctions> ProcessMap;
  ProcessMap processMap_;
  void process_setValue(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_setValue(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_setValue(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int32_t& _return);
  void return_setValue(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const int32_t& _return);
  void throw_setValue(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_setValue(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_getValue(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getValue(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_getValue(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int32_t& _return);
  void return_getValue(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const int32_t& _return);
  void throw_getValue(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_getValue(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
 public:
