...
typedef struct _TUnion__isset {
  _TUnion__isset() : string_field(false), i32_field(false) {}
  bool string_field;
  bool i32_field;
} _TUnion__isset;
...
class TUnion {
 public:
  ...
  TUnion() : string_field(), i32_field(0) {
  }

  virtual ~TUnion() throw() {}
  ...
  _TUnion__isset __isset;

  void __set_string_field(const std::string& val) {
    string_field = val;
    __isset = _TUnion__isset();
    __isset.string_field = true;
  }
  ...
  bool operator == (const TUnion & rhs) const
  {
  ...
  bool operator < (const TUnion & ) const;
