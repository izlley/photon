...
class OneOfEach {
 public:
  ...
  void __set_zomg_unicode(const std::string& val) {
    zomg_unicode = val;
    __isset.zomg_unicode = true;
  }

  void __set_what_who(const bool val) {
    what_who = val;
    __isset.what_who = true;
  }
...
class Backwards {
 public:
  ...
  void __set_first_tag2(const int32_t val) {
    first_tag2 = val;
    __isset.first_tag2 = true;
  }

  void __set_second_tag1(const int32_t val) {
    second_tag1 = val;
    __isset.second_tag1 = true;
  }
...
class TestUnionMinusStringField {
 public:
  ...
  void __set_i32_field(const int32_t val) {
    i32_field = val;
    __isset = _TestUnionMinusStringField__isset();
    __isset.i32_field = true;
  }
...
class ComparableUnion {
 public:
  ...
  void __set_string_field(const std::string& val) {
    string_field = val;
    __isset = _ComparableUnion__isset();
    __isset.string_field = true;
  }
