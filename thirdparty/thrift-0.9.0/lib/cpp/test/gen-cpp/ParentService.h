...
class ParentServiceCobClIfT {
 public:
  ...
  virtual void incrementGeneration(std::tr1::function<void(ParentServiceCobClientT<Protocol_>* client)> cob) = 0;
  virtual void getGeneration(std::tr1::function<void(ParentServiceCobClientT<Protocol_>* client)> cob) = 0;
  virtual void addString(std::tr1::function<void(ParentServiceCobClientT<Protocol_>* client)> cob, const std::string& s) = 0;
  virtual void getStrings(std::tr1::function<void(ParentServiceCobClientT<Protocol_>* client)> cob) = 0;
  virtual void getDataWait(std::tr1::function<void(ParentServiceCobClientT<Protocol_>* client)> cob, const int32_t length) = 0;
  virtual void onewayWait(std::tr1::function<void(ParentServiceCobClientT<Protocol_>* client)> cob) = 0;
  virtual void exceptionWait(std::tr1::function<void(ParentServiceCobClientT<Protocol_>* client)> cob, const std::string& message) = 0;
  virtual void unexpectedExceptionWait(std::tr1::function<void(ParentServiceCobClientT<Protocol_>* client)> cob, const std::string& message) = 0;
};
...
class ParentServiceCobSvIf {
 public:
  ...
  virtual void incrementGeneration(std::tr1::function<void(int32_t const& _return)> cob) = 0;
  virtual void getGeneration(std::tr1::function<void(int32_t const& _return)> cob) = 0;
  virtual void addString(std::tr1::function<void()> cob, const std::string& s) = 0;
  virtual void getStrings(std::tr1::function<void(std::vector<std::string>  const& _return)> cob) = 0;
  virtual void getDataWait(std::tr1::function<void(std::string const& _return)> cob, const int32_t length) = 0;
  virtual void onewayWait(std::tr1::function<void()> cob) = 0;
  virtual void exceptionWait(std::tr1::function<void()> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& message) = 0;
  virtual void unexpectedExceptionWait(std::tr1::function<void()> cob, const std::string& message) = 0;
};
...
class ParentServiceCobClientT : virtual public ParentServiceCobClIfT<Protocol_> {
 public:
  ...
  void incrementGeneration(std::tr1::function<void(ParentServiceCobClientT<Protocol_>* client)> cob);
  void send_incrementGeneration();
  int32_t recv_incrementGeneration();
  void getGeneration(std::tr1::function<void(ParentServiceCobClientT<Protocol_>* client)> cob);
  void send_getGeneration();
  int32_t recv_getGeneration();
  void addString(std::tr1::function<void(ParentServiceCobClientT<Protocol_>* client)> cob, const std::string& s);
  void send_addString(const std::string& s);
  void recv_addString();
  void getStrings(std::tr1::function<void(ParentServiceCobClientT<Protocol_>* client)> cob);
  void send_getStrings();
  void recv_getStrings(std::vector<std::string> & _return);
  void getDataWait(std::tr1::function<void(ParentServiceCobClientT<Protocol_>* client)> cob, const int32_t length);
  void send_getDataWait(const int32_t length);
  void recv_getDataWait(std::string& _return);
  void onewayWait(std::tr1::function<void(ParentServiceCobClientT<Protocol_>* client)> cob);
  void send_onewayWait();
  void exceptionWait(std::tr1::function<void(ParentServiceCobClientT<Protocol_>* client)> cob, const std::string& message);
  void send_exceptionWait(const std::string& message);
  void recv_exceptionWait();
  void unexpectedExceptionWait(std::tr1::function<void(ParentServiceCobClientT<Protocol_>* client)> cob, const std::string& message);
  void send_unexpectedExceptionWait(const std::string& message);
  void recv_unexpectedExceptionWait();
 protected:
...
class ParentServiceAsyncProcessorT : public ::apache::thrift::async::TAsyncDispatchProcessorT<Protocol_> {
 protected:
  ...
  virtual void dispatchCallTemplated(std::tr1::function<void(bool ok)> cob, Protocol_* iprot, Protocol_* oprot, const std::string& fname, int32_t seqid);
 private:
  typedef  void (ParentServiceAsyncProcessorT::*ProcessFunction)(std::tr1::function<void(bool ok)>, int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*);
  typedef void (ParentServiceAsyncProcessorT::*SpecializedProcessFunction)(std::tr1::function<void(bool ok)>, int32_t, Protocol_*, Protocol_*);
  struct ProcessFunctions {
    ProcessFunction generic;
    SpecializedProcessFunction specialized;
    ProcessFunctions(ProcessFunction g, SpecializedProcessFunction s) :
  ...
  typedef std::map<std::string, ProcessFunctions> ProcessMap;
  ProcessMap processMap_;
  void process_incrementGeneration(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_incrementGeneration(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_incrementGeneration(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int32_t& _return);
  void return_incrementGeneration(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const int32_t& _return);
  void throw_incrementGeneration(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_incrementGeneration(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_getGeneration(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getGeneration(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_getGeneration(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int32_t& _return);
  void return_getGeneration(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const int32_t& _return);
  void throw_getGeneration(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_getGeneration(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_addString(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_addString(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_addString(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void return_addString(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx);
  void throw_addString(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_addString(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_getStrings(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getStrings(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_getStrings(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<std::string> & _return);
  void return_getStrings(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::vector<std::string> & _return);
  void throw_getStrings(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_getStrings(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_getDataWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_getDataWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_getDataWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return);
  void return_getDataWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::string& _return);
  void throw_getDataWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_getDataWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_onewayWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_onewayWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_onewayWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void return_onewayWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx);
  void throw_onewayWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_onewayWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_exceptionWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_exceptionWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_exceptionWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void return_exceptionWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx);
  void throw_exceptionWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_exceptionWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_unexpectedExceptionWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_unexpectedExceptionWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_unexpectedExceptionWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void return_unexpectedExceptionWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx);
  void throw_unexpectedExceptionWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_unexpectedExceptionWait(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
 public:
