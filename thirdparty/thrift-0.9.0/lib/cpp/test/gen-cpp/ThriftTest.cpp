...
uint32_t ThriftTest_testUnion_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t ThriftTest_testUnion_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  uint32_t fcnt = 0;
...
uint32_t ThriftTest_testUnion_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  uint32_t fcnt = 0;
...
uint32_t ThriftTest_testUnion_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t ThriftTest_testUnion_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
...
uint32_t ThriftTest_testUnion_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void ThriftTestClient::testUnion(TUnion& _return, const TUnion& thing)
{
  send_testUnion(thing);
  recv_testUnion(_return);
}

void ThriftTestClient::send_testUnion(const TUnion& thing)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("testUnion", ::apache::thrift::protocol::T_CALL, cseqid);
...
void ThriftTestClient::recv_testUnion(TUnion& _return)
{
...
void ThriftTestProcessor::process_testUnion(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
