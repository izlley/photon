...
template <class Protocol_>
uint32_t ThriftTest_testUnion_args::read(Protocol_* iprot) {
...
template <class Protocol_>
uint32_t ThriftTest_testUnion_args::write(Protocol_* oprot) const {
  uint32_t xfer = 0;
  uint32_t fcnt = 0;
  xfer += oprot->writeStructBegin("ThriftTest_testUnion_args");
...
template <class Protocol_>
uint32_t ThriftTest_testUnion_pargs::write(Protocol_* oprot) const {
  uint32_t xfer = 0;
  uint32_t fcnt = 0;
  xfer += oprot->writeStructBegin("ThriftTest_testUnion_pargs");
...
template <class Protocol_>
uint32_t ThriftTest_testUnion_result::read(Protocol_* iprot) {
...
template <class Protocol_>
uint32_t ThriftTest_testUnion_result::write(Protocol_* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("ThriftTest_testUnion_result");
...
template <class Protocol_>
uint32_t ThriftTest_testUnion_presult::read(Protocol_* iprot) {
...
template <class Protocol_>
uint32_t ThriftTest_testUnion_presult::write(Protocol_* oprot) const {
  uint32_t xfer = 0;
  uint32_t fcnt = 0;
  xfer += oprot->writeStructBegin("ThriftTest_testUnion_presult");
...
template <class Protocol_>
void ThriftTestClientT<Protocol_>::testUnion(TUnion& _return, const TUnion& thing)
{
  send_testUnion(thing);
  recv_testUnion(_return);
}

template <class Protocol_>
void ThriftTestClientT<Protocol_>::send_testUnion(const TUnion& thing)
{
  int32_t cseqid = 0;
  this->oprot_->writeMessageBegin("testUnion", ::apache::thrift::protocol::T_CALL, cseqid);

  ThriftTest_testUnion_pargs args;
  args.thing = &thing;
  args.write(this->oprot_);
...
template <class Protocol_>
void ThriftTestClientT<Protocol_>::recv_testUnion(TUnion& _return)
{
  ...
  if (fname.compare("testUnion") != 0) {
    this->iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    this->iprot_->readMessageEnd();
    this->iprot_->getTransport()->readEnd();
  }
  ThriftTest_testUnion_presult result;
  result.success = &_return;
  result.read(this->iprot_);
  this->iprot_->readMessageEnd();
  this->iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "testUnion failed: unknown result");
}
...
template <class Protocol_>
void ThriftTestProcessorT<Protocol_>::process_testUnion(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("ThriftTest.testUnion", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "ThriftTest.testUnion");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "ThriftTest.testUnion");
  }

  ThriftTest_testUnion_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "ThriftTest.testUnion", bytes);
  }

  ThriftTest_testUnion_result result;
  try {
    iface_->testUnion(result.success, args.thing);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "ThriftTest.testUnion");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("testUnion", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "ThriftTest.testUnion");
  }

  oprot->writeMessageBegin("testUnion", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "ThriftTest.testUnion", bytes);
  }
}

template <class Protocol_>
void ThriftTestProcessorT<Protocol_>::process_testUnion(int32_t seqid, Protocol_* iprot, Protocol_* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("ThriftTest.testUnion", callContext);
...
template <class Protocol_>
void ThriftTestCobClientT<Protocol_>::testUnion(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const TUnion& thing)
{
  send_testUnion(thing);
  this->channel_->sendAndRecvMessage(std::tr1::bind(cob, this), this->otrans_.get(), this->itrans_.get());
}
...
template <class Protocol_>
void ThriftTestCobClientT<Protocol_>::send_testUnion(const TUnion& thing)
{
  int32_t cseqid = 0;
  this->oprot_->writeMessageBegin("testUnion", ::apache::thrift::protocol::T_CALL, cseqid);
...
template <class Protocol_>
void ThriftTestCobClientT<Protocol_>::recv_testUnion(TUnion& _return)
{
...
template <class Protocol_>
void ThriftTestAsyncProcessorT<Protocol_>::dispatchCall(std::tr1::function<void(bool ok)> cob, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, const std::string& fname, int32_t seqid) {
  typename ProcessMap::iterator pfn;
  pfn = processMap_.find(fname);
  if (pfn == processMap_.end()) {
    iprot->skip(::apache::thrift::protocol::T_STRUCT);
...
template <class Protocol_>
void ThriftTestAsyncProcessorT<Protocol_>::dispatchCallTemplated(std::tr1::function<void(bool ok)> cob, Protocol_* iprot, Protocol_* oprot, const std::string& fname, int32_t seqid) {
  typename ProcessMap::iterator pfn;
  pfn = processMap_.find(fname);
  if (pfn == processMap_.end()) {
    iprot->skip(::apache::thrift::protocol::T_STRUCT);
...
template <class Protocol_>
void ThriftTestAsyncProcessorT<Protocol_>::process_testUnion(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  Protocol_* _iprot = dynamic_cast<Protocol_*>(iprot);
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_iprot && _oprot) {
    return process_testUnion(cob, seqid, _iprot, _oprot);
  }
  T_GENERIC_PROTOCOL(this, iprot, _iprot);
  T_GENERIC_PROTOCOL(this, oprot, _oprot);
  ...
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("ThriftTest.testUnion", NULL);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "ThriftTest.testUnion");
  ...
  freer.unregister();
  void (ThriftTestAsyncProcessorT<Protocol_>::*return_fn)(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const TUnion& _return) =
    &ThriftTestAsyncProcessorT<Protocol_>::return_testUnion;
  iface_->testUnion(
      std::tr1::bind(return_fn, this, cob, seqid, oprot, ctx, std::tr1::placeholders::_1),
      args.thing);
}
...
template <class Protocol_>
void ThriftTestAsyncProcessorT<Protocol_>::return_testUnion(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const TUnion& _return)
{
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_oprot) {
    return return_testUnion(cob, seqid, _oprot, ctx, _return);
  }
  T_GENERIC_PROTOCOL(this, oprot, _oprot);

  ThriftTest_testUnion_presult result;
  result.success = const_cast<TUnion*>(&_return);
  result.__isset.success = true;
...
template <class Protocol_>
void ThriftTestAsyncProcessorT<Protocol_>::process_testUnion(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot)
{
  ThriftTest_testUnion_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (ThriftTestAsyncProcessorT<Protocol_>::*return_fn)(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const TUnion& _return) =
    &ThriftTestAsyncProcessorT<Protocol_>::return_testUnion;
  iface_->testUnion(
      std::tr1::bind(return_fn, this, cob, seqid, oprot, ctx, std::tr1::placeholders::_1),
      args.thing);
...
template <class Protocol_>
void ThriftTestAsyncProcessorT<Protocol_>::return_testUnion(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const TUnion& _return)
{
  ThriftTest_testUnion_presult result;
  result.success = const_cast<TUnion*>(&_return);
  result.__isset.success = true;
